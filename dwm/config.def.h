...
#else
static const char *fonts[] = { "Nerd Font:size=12" }; // Change size as needed
//static const char *fonts[]               = { "monospace:size=10" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[] = "Nerd Font:size=12"; // For dmenu
...
static char titlenormfgcolor[]           = "#00FF00";
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        0,                   Button3,        sigstatusbar,   {.i = 3 } },	
 	{ ClkStatusText, ShiftMask,					 Button1,		 sigstatusbar, 	 {.i = 4 } }, // Shift + Left click
    { ClkStatusText, Mod1Mask, 					 Button1, 		 sigstatusbar, 	 {.i = 5 } }, // Alt + left click
    { ClkStatusText, ControlMask, 				 Button1, 		 sigstatusbar, 	 {.i = 6 } },
    { ClkStatusText, ShiftMask,				     Button2, 		 sigstatusbar,	 {.i = 7 } },
	{ ClkStatusText, Mod1Mask, 				     Button2, 		 sigstatusbar, 	 {.i = 8 } },
    { ClkStatusText, ControlMask, 				 Button2,		 sigstatusbar, 	 {.i = 9 } },
    { ClkStatusText, ShiftMask,				     Button3, 		 sigstatusbar, 	 {.i = 10 } },
    { ClkStatusText, Mod1Mask, 				     Button3, 		 sigstatusbar,	 {.i = 11 } },
    { ClkStatusText, ControlMask, 				 Button3, 		 sigstatusbar, 	 {.i = 12 } },
